...
[https://youtu.be/yXFb8Cg9l7g](https://youtu.be/yXFb8Cg9l7g)
【大模型应用开发-MCP系列】高德地图MCP Server SSE+HTTP连接模式全流程实操演示 已覆盖12大核心服务接口，提供全场景覆盖的地图服务
[https://youtu.be/OLVHObhEP0U](https://youtu.be/OLVHObhEP0U)
...
进入到02_ReActAgentHILTest中运行 `01_reviewCustomToolCalls.py` 脚本进行测试
进入到02_ReActAgentHILTest中运行 `02_reviewMCPToolCalls.py` 脚本进行测试
进入到02_ReActAgentHILTest中运行 `03_reviewMixToolCalls.py` 脚本进行测试
