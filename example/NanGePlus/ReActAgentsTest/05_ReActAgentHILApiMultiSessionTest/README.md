...
本期视频是在ReActAgentsTest项目基础进行更新，并在04_ReActAgentHILApiTest应用案例中进行迭代，所使用的代码文件夹为:**05_ReActAgentHILApiMultiSessionTest**,源码及相关资料均开源免费共享给大家，大家进入项目中进行下载:
[https://github.com/NanGePlus/ReActAgentsTest](https://github.com/NanGePlus/ReActAgentsTest)
[https://gitee.com/NanGePlus/ReActAgentsTest](https://gitee.com/NanGePlus/ReActAgentsTest)
关于04_ReActAgentHILApiTest应用案例，从零构建生产级AI Agent服务:LangGraph+FastAPI实现工具扩展/MCP集成/记忆/人工审查/故障恢复API后端接口服务(含完整前端demo)
[https://youtu.be/rF9KEzmVt6Y](https://youtu.be/rF9KEzmVt6Y)
[https://www.bilibili.com/video/BV1pcMbz9Epz/](https://www.bilibili.com/video/BV1pcMbz9Epz/)
...
MCP官方简介: [https://www.anthropic.com/news/model-context-protocol](https://www.anthropic.com/news/model-context-protocol)
MCP文档手册: [https://modelcontextprotocol.io/introduction](https://modelcontextprotocol.io/introduction)
MCP官方服务器列表: [https://github.com/modelcontextprotocol/servers](https://github.com/modelcontextprotocol/servers)
PythonSDK的github地址: [https://github.com/modelcontextprotocol/python-sdk](https://github.com/modelcontextprotocol/python-sdk)
南哥AGI研习社MCP项目分享地址: [https://github.com/NanGePlus/MCPServerTest](https://github.com/NanGePlus/MCPServerTest)
...
[https://youtu.be/EId3Kbmb_Ao](https://youtu.be/EId3Kbmb_Ao)
[https://www.bilibili.com/video/BV1ZHEgzXEP1/](https://www.bilibili.com/video/BV1ZHEgzXEP1/)
...
打开命令行终端，cd 05_ReActAgentHILApiMultiSessionTest文件夹下
进入到 `docker/postgresql` 下执行 `docker-compose up -d` 运行PostgreSQL服务
进入到 `docker/redis` 下执行 `docker-compose up -d` 运行Redis服务
...
链接地址: [https://lbs.amap.com/api/mcp-server/summary](https://lbs.amap.com/api/mcp-server/summary)
具体提供的接口详情介绍:
