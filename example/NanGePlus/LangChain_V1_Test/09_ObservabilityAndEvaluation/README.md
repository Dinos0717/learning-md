...
官网地址:[https://langfuse.com/docs](https://langfuse.com/docs)
...
进入官网 [https://github.com/langfuse/langfuse/tree/main](https://github.com/langfuse/langfuse/tree/main) 或通过命令
`git clone https://github.com/langfuse/langfuse.git` 下载安装源码

打开命令行终端执行 `docker-compose up -d` 运行 langfuse 服务
运行成功后可在浏览器中访问 [http://localhost:3000](http://localhost:3000)
