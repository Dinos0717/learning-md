...
(2)MetaGPT功能测试
相关视频:
[B站视频](https://www.bilibili.com/video/BV1DEivY5Ewe/)
[YouTube视频](https://youtu.be/SHgKxq5ovtc)
...
**github地址**: [MetaGPT GitHub](https://github.com/geekan/MetaGPT)
**官网地址**: [MetaGPT官网](https://docs.deepwisdom.ai/main/zh/)
**文档地址**: [MetaGPT文档](https://docs.deepwisdom.ai/main/zh/guide/get_started/introduction.html)
...
[GitHub地址](https://github.com/NanGePlus/MetaGPTTest)
[Gitee地址](https://gitee.com/NanGePlus/MetaGPTTest)
...
**(2)手动创建配置文件**
在当前的代码同级目录下手动创建配置文件
创建`config`文件夹，并在该文件夹内创建`config2.yaml`文件
