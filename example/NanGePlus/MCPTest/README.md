...
[Bilibili视频链接](https://www.bilibili.com/video/BV1HBquYbE7t/)

[Youtube链接](https://youtu.be/Jmo7rgb_OXQ)
...
[Bilibili视频链接](https://www.bilibili.com/video/BV1ELq4YME8T/)

[Youtube链接](https://youtu.be/yaLAqEMz45A)
...
[Bilibili视频链接](https://www.bilibili.com/video/BV1oNqaYJEUy/)

[Youtube链接](https://youtu.be/tG-ZjOgrcSA)
...
[Bilibili视频链接](https://www.bilibili.com/video/BV1SckXY3E6S/)

[Youtube链接](https://youtu.be/9pzS9saNcGA)
...
- 调用(Invocation):使用 `tools/call` 端点调用工具，服务器在其中执行请求的操作并返回结果
...
[https://github.com/NanGePlus/MCPTest](https://github.com/NanGePlus/MCPTest)

[https://gitee.com/NanGePlus/MCPTest](https://gitee.com/NanGePlus/MCPTest)
...
对应的链接: [https://github.com/modelcontextprotocol/servers/tree/main/src/filesystem](https://github.com/modelcontextprotocol/servers/tree/main/src/filesystem)

**代码目录**

脚本放置在 `nangeAGICode/basic`、`filesystem_basic`、`filesystem_chat` 目录内,运行对应脚本进行测试
...
脚本放置在 `nangeAGICode/mysql_chat` 目录内,运行对应脚本进行测试
...
脚本放置在 `nangeAGICode/mysql_filesystem_chat` 目录内,运行对应脚本进行测试
...
脚本放置在 `nangeAGICode/search_mysql_filesystem_chat` 目录内,运行对应脚本进行测试
