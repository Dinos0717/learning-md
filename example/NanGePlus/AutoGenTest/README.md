...
- [B站视频](https://www.bilibili.com/video/BV1tGzSYxEZe/)
- [YouTube视频](https://youtu.be/jbEXvhWACqk)
...
- **`reset()`**: 若上一个任务与下一个任务无关，则重置Team的状态。否则，Team可以利用上一个任务的上下文来处理下一个任务
...
- [GitHub](https://github.com/NanGePlus/AutoGenTest)
- [Gitee](https://gitee.com/NanGePlus/AutoGenTest)
...
相关测试代码在 `nangeAGICode/RoundRobinGroupChat` 文件夹下
